        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            ...
            <td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Jordan.svg" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
            ...
            <tr>
            <td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/800px-Flag_of_Egypt.webp" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
          ...
          <tr>
          <td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Kazakhstan.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Belgium_(civil).svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Azerbaijan.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Thailand.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Spain.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_France.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/800px-Flag_of_Argentina.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Poland.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>

<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">Польша</td>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">Варшава</td>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">1997</td>
</tr>

<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Italy.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Palestine.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Russia.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Cuba.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Germany.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Sweden.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Austria.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Latvia.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Tajikistan.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Armenia.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Croatia.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Finland.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Iran.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_South_Africa.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Lithuania.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/800px-Flag_of_Canada.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Sri_Lanka.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Romania.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Slovakia.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_the_United_States.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/800px-Flag_of_the_United_Kingdom.webp" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Slovenia.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Australia.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Belarus.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Uruguay.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_India.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Denmark.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Japan_(geometric).png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Kyrgyzstan_(1992-2023).png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_the_People's_Republic_of_China.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Greece.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Bulgaria.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_South_Korea.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/720px-Flag_of_Brazil.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/800px-Flag_of_the_Netherlands.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Norway.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Turkey.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Estonia.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/800px-Flag_of_Georgia.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/660px-Flag_of_Israel.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Vietnam.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
...
<tr>
<td className="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                <img src="flags/Flag_of_Sudan.svg.png" alt="Флаг страны 1" className="w-8 h-auto" />
              </td>
