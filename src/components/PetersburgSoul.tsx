      ...
      <div className="max-w-screen-lg mx-auto">
        ...
        <div className="text-black-700 mb-10 px-4 sm:px-4 text-sm">
          <p className="mt-4 mb-4">
            ...
            к поколению, лежащие в основе общероссийской гражданской
            идентичности и единого культурного пространства страны, укрепляющие
            гражданское единство, нашедшие свое уникальное, самобытное
            проявление в духовном, историческом и культурном развитии
          ...
          <p className="mb-4">
            ...
            оказали значительное влияние на формирование традиционных ценностей,
            общих для верующих и неверующих граждан. Особая роль в становлении и
            укреплении традиционных ценностей принадлежит православию.
          </p>
          ...
          <p className="mb-4">
            ...
            России, обеспечивать единство нашей многонациональной и
            многоконфессиональной страны, осуществлять сбережение народа России
            и развитие человеческого потенциала.
          </p>

          <p className="font-bold text-black-1000 mb-4">
